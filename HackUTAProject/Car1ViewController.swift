...
class Car1ViewController: UIViewController {
    ...
    @IBAction func remindAction(_ sender: Any) {
        sendNotification(title: "Reminder for Car 1", message: reminderTF.text, date: datePicker.date)
        var newReminder = Reminder(title: "Car 1", message: reminderTF.text, date: datePicker.date)
